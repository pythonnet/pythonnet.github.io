...
**Running on Linux/Mono:** Unit testing shows that PythonNet will run under [Mono][7], though the Mono runtime is less supported so there still may be problems.
...
Python for .NET is released under the open source MIT License. A copy of the license is included in the distribution, or you can find a copy of the [ license online ][9]. Some distributions of this package include a copy of the C Python dlls and standard library, which are covered by the [ Python license ][10].
